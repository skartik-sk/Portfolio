...
const HoverDevCards = () => {
  return (
    <div className="px-16  ">
    <span className="text-transparent px-14  text-4xl font-extrabold pb-3    bg-clip-text bg-gradient-background">
      ...
      <div className="grid gap-4 py-6 grid-cols-2 lg:grid-cols-4">
        <Card
          ...
          Icon={IoLogoAndroid}
        />
        <Card title="React" subtitle="Web Development" href="#" Icon={IoLogoReact} />
        <Card title="Flutter" subtitle="Android app Development" href="#" Icon={SiFlutter} />
        <Card
          title="UI/UX"
